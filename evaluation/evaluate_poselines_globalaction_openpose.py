...
INPUT_DIR = "/Users/tilman/Documents/Programme/Python/new_bachelor_thesis/datasets/dirk_27.11.2020_Sample_Adoration_Annunciation_Baptism/Baptism"
OUTPUT_DIR = "/Users/tilman/Documents/Programme/Python/new_bachelor_thesis/evaluation/compoelem/v0.0.7_12.01.21/dirk_27.11.2020_Sample_Adoration_Annunciation_Baptism/Baptism"

def get_icc(output_dir, img_path):
    basename = os.path.basename(img_path)
    img = cv2.imread(img_path)
    if img is None:
        print("could not open img:", img_path)
        return
