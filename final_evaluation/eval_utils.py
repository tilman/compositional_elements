...
def score_retrievals(label, retrievals):
    ...
    precision_at_2 = precision_at_rank[1]
    precision_at_3 = precision_at_rank[2]
    precision_at_5 = precision_at_rank[4]
    precision_at_10 = precision_at_rank[9]
    precision_at_20 = precision_at_rank[19]
    precision_at_30 = precision_at_rank[29]
    ...
    recall_at_2 = recall_at_rank[1]
    recall_at_3 = recall_at_rank[2]
    recall_at_5 = recall_at_rank[4]
    recall_at_10 = recall_at_rank[9]
    recall_at_20 = recall_at_rank[19]
    recall_at_30 = recall_at_rank[29]
    ...
    metrics = {
        "label": label,
        "precision_at_rank": precision_at_rank[0:50],
        "p@1": precision_at_1,
        "p@2": precision_at_2,
        "p@3": precision_at_3,
        "p@5": precision_at_5,
...
def get_eval_dataframe(res_metrics):
    ...
    for metricKey in res_metrics.keys():
        if metricKey != "label" and metricKey != "precision_at_rank":
