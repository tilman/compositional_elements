...
from . import compare_compoelem_grid_tune
...
# pickle.dump(evaluation_log, open(EVAL_RESULTS_FILE, "wb"))
[evaluation_log.append(experiment) for experiment in compare_compoelem_grid_tune.eval_all_combinations(datastore, DATASTORE_NAME)] 
pickle.dump(evaluation_log, open(EVAL_RESULTS_FILE, "wb"))
