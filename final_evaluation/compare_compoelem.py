...
def compare_setupA(data, sort_method, norm_method, pose_lines_key):
    ...
    for query_data in tqdm(data, total=len(data)):
        ...
        query_pose_lines_seq = norm_by_global_action(query_data["compoelem"][pose_lines_key], query_data["compoelem"]["global_action_lines"])
        for target_data in data:
            ...
            target_pose_lines_seq = norm_by_global_action(target_data["compoelem"][pose_lines_key], target_data["compoelem"]["global_action_lines"])
